...
/**
 * input_buf - this helps the buffer chained commands
 * @info: this is the parameter struct
 * @buf: this is the address of buffer
 * @len: this in the address of len var
...
/**
 * get_input -helps to get a line minus the newline
 * @info: provides the parameter struct
 * Return: returns bytes to read
 */
...
/**
 * read_buf - this helps to read a buffer
 * @info: this is the parameter struct
 ...
 * @info: this is the parameter struct
 * @ptr: this helps points address to buffer, preallocated or NULL
